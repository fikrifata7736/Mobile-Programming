...
public class TampilanPertamaActivity extends AppCompatActivity {
    private ImageView setMeja,setLemari,setSofa,setProfil, setShop,btnSwipe;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderItems.add(new SliderItem(R.drawable.item_1));
        sliderItems.add(new SliderItem(R.drawable.item_2));
        sliderItems.add(new SliderItem(R.drawable.item_3));
        ...
        btnSwipe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.btnswipe:
                        startActivity(new Intent(TampilanPertamaActivity.this, CheckoutActivity.class));
                        break;
        ...
        setLemari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.setLemari:
                        startActivity(new Intent(TampilanPertamaActivity.this, TampilanKetigaActivity.class));
                        break;
        ...
        setSofa.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.setSofa:
                        startActivity(new Intent(TampilanPertamaActivity.this, TampilanKeempatActivity.class));
                        break;
        ...
        setProfil.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.setProfil:
                        startActivity(new Intent(TampilanPertamaActivity.this, ProfilActivity.class));
                        break;
        ...
        setShop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.setShop:
                        startActivity(new Intent(TampilanPertamaActivity.this, TampilanProductActivity.class));
                        break;
        ...
        setMeja.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                switch (v.getId()){
                    case R.id.setMeja:
                        startActivity(new Intent(TampilanPertamaActivity.this, TampilanKeduaActivity.class));
                        break;
